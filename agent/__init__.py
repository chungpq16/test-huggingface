...
Use the following format when you need to use a tool:
...
If you can answer the question directly without using any tools, use this format:

Question: the input question you must answer
Thought: I can answer this directly without using any tools
Final Answer: the final answer to the original input question

Always think carefully about whether you need to use a tool or if you can answer directly.
